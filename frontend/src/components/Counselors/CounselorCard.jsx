...
const CounselorCard = ({ counselor }) => {
  ...
  return (
    <div className='p-3 lg:p-5 rounded-lg shadow-lg transition-transform transform hover:scale-105'>
      <div>
        <img src={photo} className='w-full h-[320px]' alt="" />
      </div>
      <h2 className='text-[18px] leading-[30px] lg:text-[26px] lg:leading-9
        text-headingColor font-[700] mt-2 lg:mt-5'>{name}
      </h2>
