...
const Profile = ({ counselorData }) => {
    ...
    const updateProfileHandler = async e => {
        ...
        try {
            const res = await fetch(`${BASE_URL}/counselors/${counselorData._id}`, {
                method: 'PUT',
                headers: {
    ...
    const addExperience = e => {
        ...
        addItem("experiences", {
            startingDate: "", endingDate: "", position: "Senior Counselor ", company: "Team Dynamics Inc.",
    ...
    return (
        <div>
            ...
            <form>
                ...
                {/* gender, specialization, ticket-price form start */}
                <div className="mb-5">
                    <div className="grid grid-cols-3 gap-5 mb-[30px]">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                <option value="soft skills counselor">Soft Skills Counselor</option>
                            </select>
                        </div>
                        <div>
                ...
                <div className="mb-5">
                    <p className="form___label">Qualifications*</p>
                ...
                <div className="mb-5">
                    <p className="form___label">Experiences*</p>
                ...
                {/* Time-slots form start */}
                <div className="mb-5">
                    <p className="form___label">Time Slots*</p>
